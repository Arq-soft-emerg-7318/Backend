...
public class LikeController {
    ...
    public LikeController(LikeCommandService likeCommand, LikeQueryService likeQueryService) {
    ...
    public ResponseEntity<Map<String, Long>> countLikes(@PathVariable Long postId) {
        long count = likeQueryService.handle(new GetAllLikesByPostIdQuery(postId));
